...
public class MovieResponse extends RealmObject{
    ...
    private RealmList<ProductionCompany> mProductionCompanies;
    @SerializedName("production_countries")
    private RealmList<ProductionCountry> mProductionCountries;
    ...
    private RealmList<SpokenLanguage> mSpokenLanguages;
